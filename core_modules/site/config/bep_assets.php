...
$config['asset'][] = array('file'=>'easyui/datagrid-detailview.js', 'needs'=>'easyui.min');
$config['asset'][] = array('file'=>'easyui/jquery.edatagrid.js', 'needs'=>'easyui.min');
...
$config['asset_group']['EASYUI']='easyui|icon|easyui.min|easyui.ext|datagrid-detailview|jquery.edatagrid';
