...
class Acl_permissions extends Admin_Controller
{
	...
	function index()
	{
		...
		$data['page'] = $this->config->item('template_admin') . "access_control/permissions";
		$data['module'] = 'auth';
	...
	function form($id = NULL)
	{
		...
		$data['page'] = $this->config->item('template_admin') . "access_control/form_permission";
		$data['module'] = 'auth';
		$this->load->view($this->_container,$data);
	}
	...
	function show()
	{
		...
		$data['page'] = $this->config->item('template_admin') . "access_control/view_advanced_permissions";
		$data['module'] = 'auth';
		$this->load->view($this->_container,$data);
	}
