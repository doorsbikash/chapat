...
<a href="<?php print site_url('auth/admin/acl_resources/form')?>" class="easyui-linkbutton" iconCls="icon-add">
...
<a href="<?php print site_url('auth/admin/access_control')?>" class="easyui-linkbutton" iconCls="icon-back">
