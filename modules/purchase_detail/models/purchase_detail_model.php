...
class Purchase_detail_model extends MY_Model
{
    ...
    public function __construct()
    {
    	parent::__construct();
        $this->prefix='tbl_';
        $this->_TABLES=array('PURCHASE_DETAIL'=>$this->prefix.'purchase_detail');
    ...
    public function getPurchaseDetails($where=NULL,$order_by=NULL,$limit=array('limit'=>NULL,'offset'=>''))
    {
